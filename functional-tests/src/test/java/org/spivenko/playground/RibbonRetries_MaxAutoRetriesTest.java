...
@DirtiesContext
public class RibbonRetries_MaxAutoRetriesTest extends BaseTestClass {
    ...
    static void loadProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("random-number-service-client.ribbon.MaxAutoRetriesNextServer", () -> 0);
        registry.add("random-number-service-client.ribbon.retryableStatusCodes", () -> 500);
    }

    @Test
    public void shouldRetryOnceOnTheFirstServerOnly() {
